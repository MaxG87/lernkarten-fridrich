...
oll_algorithms: list[AlgorithmConfig] = [
    ...
    OLLAlgorithmConfig(
        "OLL 11",
        3,
        Algorithm("y (R2 U)(R U R' U')(R' U')(R' U R')"),
        ["3x3x3", "OLL"],
    ),
    OLLAlgorithmConfig(
        "OLL 12",
    ...
    OLLAlgorithmConfig(
        "OLL 17",
        3,
        Algorithm("R2 U R' y (R U' R' U) y' R U' R2"),
        ["3x3x3", "OLL"],
    ),
    OLLAlgorithmConfig(
        "OLL 18",
    ...
    OLLAlgorithmConfig(
        "OLL 20",
        3,
        Algorithm("y2 (R' U2 R) U z D' (R U)(R' D R U') z'"),
        ["3x3x3", "OLL"],
    ),
    OLLAlgorithmConfig(
        "OLL 21",
    ...
    OLLAlgorithmConfig(
        "OLL 22",
        3,
        Algorithm("(R U R' U')(R' F)(R U')(R' U' R U) R' F'"),
        ["3x3x3", "OLL"],
    ),
    OLLAlgorithmConfig(
        "OLL 23",
    ...
    OLLAlgorithmConfig(
        "OLL 26",
        3,
        Algorithm("(L U') R U2 (L' U) R' U'"),
        ["3x3x3", "OLL"],
    ),
    OLLAlgorithmConfig(
        "OLL 27",
        3,
        Algorithm("(R' U) L' U2 (R U') L U"),
        ["3x3x3", "OLL"],
    ),
    OLLAlgorithmConfig(
        "OLL 28",
    ...
    OLLAlgorithmConfig(
        "OLL 29",
        3,
        Algorithm("y2 (R2 u')(R U' R U)(R' u) R2 y (R U' R')"),
        ["3x3x3", "OLL"],
    ),
    OLLAlgorithmConfig(
        "OLL 30",
    ...
    OLLAlgorithmConfig(
        "OLL 31",
        3,
        Algorithm("y2 (R' U' R)(U D')(R2 U)(R' U R U')(R U') R2 D U'"),
        ["3x3x3", "OLL"],
    ),
    OLLAlgorithmConfig(
        "OLL 32",
